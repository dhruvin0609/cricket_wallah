...
def update_score(request):
    ...
    if current == 1:
        ...
        if 'dot' in request.POST:
            ...
            context.update({'ball1':players1[b1].ball, 'sc1':players1[b1].score})
            ...
            if bat1 < bat2:
                ...
                b1 = b1 + 1
                s1 = s1 + 1
            context.update({'ball1':players1[b1].ball, 'sc1':players1[s1].score, 'ball2':players1[b2].ball, 'sc2':players1[s2].score})
        ...
        if 'dot' in request.POST:
            ...
            if bat1 < bat2:
                ...
                s1 = s1 + 1
                b1 = b1 + 1
            context.update({'ball1':players2[b1].ball, 'sc1':players2[s1].score, 'ball2':players2[b2].ball, 'sc2':players2[s2].score})
